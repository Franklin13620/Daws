  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-danger alert-dismissable">
             ...
             <i class="icon-remove"></i><strong> Lista de componentes sospechosos</strong>
            </div>
       </div>
    </div>
  </div>
...
"Times New Roman","serif"'>Componentes Sospechosos:<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <a href="#" onclick="window.print()" class="btn btn-info" id="print" data-placement="top" ><i class="icon-print icon-large"></i> Imprimir</a></p>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success"  href="damage.php"><i class="icon-arrow-left"></i> Atras</a></p>
...
<?php
		$device_query = mysql_query("select * from stdevice
							 ...
							 where dev_status = 'sospechoso' ORDER BY location_details.ld_id DESC")or die(mysql_error());
...
<?php
	             $count_item=mysql_query("select * from stdevice
				 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				 where dev_status = 'damage' OR dev_status = 'Sospechoso' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
 ?>
