                 ...
                 ?> 
				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;CCN</div>
...
<div class="empty">
	<div class="control-group">
	  ...
	  <div class="control-group"> 
		<div class="controls">
		<button  class="btn btn-primary" id="snd" data-placement="right" ><i class="icon-share"> Assign Location</i></button>
