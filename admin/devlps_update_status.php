	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<a id="return" data-placement="left"  href="mydevice.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i> Atras</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										$.jGrowl("componente actualizado correctamente", { header: 'Device Status Update' });
										</script>
										<?php
										}
