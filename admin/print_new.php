  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-check"></i><strong> Lista de impresion de componentes nuevos</strong>
            </div>
       </div>
    </div>
  </div>
...
"Times New Roman","serif"'>Lista de impresion de componentes nuevos:<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <a href="#" onclick="window.print()" class="btn btn-info" id="print" data-placement="top" ><i class="icon-print icon-large"></i> Imprimir</a></p>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success"  href="newdevice.php"><i class="icon-arrow-left"></i> Atras</a></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
			   ...
			   where NOT EXISTS
	             (select * from location_details where stdevice.id = location_details.id)
	             and dev_status = 'New' and dev_name = 'Nivel D'
...
?>
 ...
 <?php
		       ...
		       where NOT EXISTS
	          (select * from location_details where stdevice.id = location_details.id)
	          and dev_status = 'New' and dev_name = 'Validacion de comp.'
...
<?php
			   ...
			   where NOT EXISTS
	             (select * from location_details where stdevice.id = location_details.id)
	             and dev_status = 'New' and dev_name = 'Test report'
...
<?php
			   ...
			   where NOT EXISTS
	             (select * from location_details where stdevice.id = location_details.id)
	             and dev_status = 'New' and dev_name = 'PPAP'
...
?>
 ...
 <?php
			   ...
			   where NOT EXISTS
	          (select * from location_details where stdevice.id = location_details.id)
	           and dev_status = 'New' and dev_name = 'CCN'
...
<?php
			   ...
			   where NOT EXISTS
	           (select * from location_details where stdevice.id = location_details.id)
	           and dev_status = 'New' and dev_name = 'QN'
