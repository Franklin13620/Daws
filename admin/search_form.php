...
<!--busqueda avanzada por ubicacion de area -->
...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
			  ...
			  <option>&larr; Seleccionar nombre de Reporte &rarr;</option>
			  <?php
			  ...
			  <?php } ?>
                ...
                <div class="control-group">
                <div class="controls">
                <button type="submit" id="search" data-placement="left" t class="btn btn-primary"><i class="icon-search"></i> Buscar</button>
