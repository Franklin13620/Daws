...
include('session.php');
$get_id = $_GET['id'];
 // interfaz para visualizar los componentes validados
...
<div class="hide">									
	...
	<div class="control-group">
	  <label class="control-label" for="inputEmail">Reporte del componente</label>
		<div class="controls">			
...
<div class="control-group">
	  <label class="control-label" for="inputEmail">Codigo</label>
		<div class="controls">			
...
<?php 
mysql_query("update stdevice set dev_status='Validado' where id = '$get_id'")or die(mysql_error());
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','componente validado $dev_name Inventory Code:$dev_serial')")or die(mysql_error());						
