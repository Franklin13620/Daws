                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-warning-signn"></i> Nivel D sospechosos</div>
...
<?php
		...
		<td class="empty">
			...
			<td><a rel="tooltip" title="Repair" id="e<?php echo $id; ?>" href="#repair<?php echo $id; ?>" data-toggle="modal" class="btn btn-success"><div class="hide">Sospechoso</div>Validar</a></td>
			<?php }else{ ?>
			<td></td>
			<?php } ?>											
