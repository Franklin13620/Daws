    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- interfaz para editar las ubicaciones en el sistema -->
				   <div class="empty">
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="muted pull-left">Lista de ubicacionest</div>                           
							<div id="" class="muted pull-right">
								<?php 
								$my_location = mysql_query("select * from stlocation ")or die(mysql_error());
								$count_my_location = mysql_num_rows($my_location);?>
								Ubicaciones totales: <span class="badge badge-info"><?php echo $count_my_location; ?></span>
						    </div>
							</div>
