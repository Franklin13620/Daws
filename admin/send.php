<!-- consulta sql para revisar cual usuario agrego un componente al sistema -->
<?php
	...
	mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','id asignado componente $id[$i] to location id $stdev_id')")or die(mysql_error());		
    }
    header("location: device_location.php");
    }  
?>
