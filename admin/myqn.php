...
<tr>
		<td><?php
			...
			<a rel="tooltip"   id="t<?php echo $id; ?>" href="devlvga_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'stdev_id='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Estado</a></td>
		</tr>
