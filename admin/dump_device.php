...
<?php include('session.php'); ?>
    <body><!-- interfaz para visualizar los componentes borrados  -->
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 where dev_status = 'Borrado' OR dev_status = 'Damage' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Lista de componentes borrados</div>
                          <div class="muted pull-right">
								Numero de componentes: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Lista de componentes borrados
 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="print_dump.php" class="btn btn-info" id="print" data-placement="left" <i class="icon-print icon-large"></i> Imprimir lista</a>  
