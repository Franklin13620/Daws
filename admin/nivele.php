                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Nivel E</div>
...
<div class="container-fluid">
 ...
 <br/>
	<div class="pull-left">
               ...
               ?>					
				<li class="active">
					<a href="nivele.php">Nivel E&nbsp;<span class="label label-default"  > <?php echo $count;?></span></a>
				</li>
               ...
               ?>					
				<li class="">
					<a href="nivelf.php">Nivel F&nbsp;<span class="label label-default"  > <?php echo $count;?></span></a>
				</li>
