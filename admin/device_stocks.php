        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
					 ...
					 <div id="sc" align="center"><image src="images/image001.png" width="45%" height="45%"/></div>
				<?php
...
<?php
		...
		<td><?php
			   ...
			   {
			   echo '<i class="icon-signout"></i><div id="hide"><strong>'.$row['dev_status'].'</strong></div>';
		       }
			...
			<td><?php
			   ...
			   {
			   echo '<div class="alert alert-warning"><i class="icon-signout"></i><strong>'.$row['dev_status'].'</strong></div>';
		       }
			   else if($row['dev_status']=='Validado')
			   {
			...
			<td class="empty" width="80"><a rel="tooltip"  id="e<?php echo $id; ?>" href="device_edit.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"> Editar</i></a></td>
		</tr>
