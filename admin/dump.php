...
<div class="control-group">
	  <label class="control-label" for="inputEmail">Codigo del componente</label>
		<div class="controls">			
...
<?php 
mysql_query("update stdevice set dev_status='Borrado' where id = '$get_id'")or die(mysql_error());
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Componente borrado $dev_name Inventory Code:$dev_serial')")or die(mysql_error());						
