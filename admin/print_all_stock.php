  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-check"></i><strong> Imprimir todos los componentes</strong>
            </div>
       </div>
    </div>
  </div>
...
"Times New Roman","serif"'>Lista de todos los componentes<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <a href="#" onclick="window.print()" class="btn btn-info" id="print" data-placement="top" ><i class="icon-print icon-large"></i> Imprimir</a></p>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success"  href="device_stocks.php"><i class="icon-arrow-left"></i> Atras</a></p>
...
$new = mysql_query("select * from stdevice
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Obsoleto'")or die(mysql_error());
$count = mysql_num_rows($new);
?>
  <td width=171 valign=top style='width:128.35pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
