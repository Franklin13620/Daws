...
<tr>
		<td><?php
			...
			<td width="185" class="empty"><a rel="tooltip"   id="e<?php echo $id; ?>" href="transfer.php<?php echo '?id='.$id; ?>&<?php echo 'stdev_id='.$get_id; ?>" class="btn btn-warning"><i class="icon-move"></i> Tranferir </a>
			<a rel="tooltip"   id="t<?php echo $id; ?>" href="devlcpu_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'stdev_id='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Estado</a></td>
		</tr>
