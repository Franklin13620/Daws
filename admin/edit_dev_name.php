    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- Interfaz para borrar o editar reportes -->
					<div class="empty">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-folder-open-alt"></i> Lista de reporte</div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_client.php" method="post">
									...
									<a data-placement="right"  data-toggle="modal" href="#client_delete" id="delete"  class="btn btn-danger" name=""><i class="icon-trash icon-large"> Borrar</i></a>
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="75">
												<a rel="tooltip"  title="Edit Client" id="e<?php echo $id; ?>" href="edit_dev_name.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Editar</i></a>
												</td>
