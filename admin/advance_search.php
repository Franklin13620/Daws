				...
				<div class="span9" id="content">
					 ...
					 <div class="empty">
			 	         <div class="alert alert-success">
                            <strong> Lista de busqueda avanzada</strong>
                       </div>
			        </div>
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Lista de resultados</div>
                          <div class="muted pull-right">
								Numero de coincidencias : <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
