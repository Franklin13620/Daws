                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Nivel D</div>
...
<tbody>
		...
		<td><?php
			...
			<td class="empty" width="80"><a rel="tooltip"  id="e<?php echo $id; ?>" href="device_edit.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"> Editar</i> </a>
			<td class="empty" width=""><a rel="tooltip"  id="e<?php echo $id; ?>" href="pdf.php<?php echo '?id='.$id; ?>" class="btn btn-warning"><i class="icon-download"> PDF reporte</i></a></td></td>
		</tr>
