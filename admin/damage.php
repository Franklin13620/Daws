...
<?php include('session.php'); ?>
    ...
    <!-- interfaz para visualizar los componentes borrados -->
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 where dev_status = 'sospechoso' OR dev_status = 'Sospechoso' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-warning-sign"></i> Lista de componentes sospechosos</div>
                          <div class="muted pull-right">
								Numero de componentes sospechosos <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Lista de componentes sospechosos
 ...
 <br/>
	<div class="pull-left">
			...
			<?php	
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Sospechoso'    and dev_name = 'Validacion de comp.'       
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="print_damage.php" class="btn btn-info" id="print" data-placement="left" ><i class="icon-print icon-large"></i> Imprimir lista</a> 	 
...
<?php
		...
		<td class="empty">
			...
			<?php }else{ ?>			
			<?php } ?>
			<td><a rel="tooltip" id="t<?php echo $id; ?>" href="#Dump<?php echo $id; ?>" data-toggle="modal" class="btn btn-danger">Borrar</a></td>
		</tr>											
	<?php } ?>   
