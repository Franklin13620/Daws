  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-danger alert-dismissable">
             ...
             <i class="icon-remove"></i><strong> Lista de componentes borrados</strong>
            </div>
       </div>
    </div>
  </div>
...
<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
font-family:"Times New Roman","serif"'>Universidad Gerardo Barrios</span></b></p>
...
"Times New Roman","serif"'>Componentes borrados:<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <a href="#" onclick="window.print()" class="btn btn-info" id="print" data-placement="top" ><i class="icon-print icon-large"></i> Imprimir</a></p>

            <p class=MsoNormal style='margin-bottom:0in; margin-top:-30px; margin-bottom:.0001pt;line-height:
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success"  href="dump_device.php"><i class="icon-arrow-left"></i> Atras</a></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:23.25pt'>
  ...
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Descripcion<o:p></o:p></span></b></p>
  </td>
  <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
...
<?php
		$device_query = mysql_query("select * from stdevice
							 ...
							 where dev_status = 'Borrado' ORDER BY location_details.ld_id DESC")or die(mysql_error());
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
			   ...
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_name = 'Nivel D' and dev_status = 'Borrado'
...
<?php
	             $count_item=mysql_query("select * from stdevice
				 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				 where dev_status = 'Borrado' OR dev_status = 'Borrado' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
 ?>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
  "Times New Roman","serif"'>Borrado<o:p></o:p></span></p>
  </td>
 ...
 <?php
			   ...
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where
			      dev_status = 'Borrado'    and dev_name = 'Validacion de comp.'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
?>
...
<?php
	           $count_item=mysql_query("select * from stdevice
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Borrado' and dev_name = 'Test report'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
?>
 ...
 <?php
	           $count_item=mysql_query("select * from stdevice
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Borrado' and dev_name = 'PPAP'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
?>
 <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
 ...
 <?php
	           $count_item=mysql_query("select * from stdevice
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Borrado' and dev_name = 'CCN'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
?>
 <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
...
<?php
	           $count_item=mysql_query("select * from stdevice
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Borrado' and dev_name = 'QN'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
?>
 <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
