...
<?php $get_id = $_GET['stdev_id']; ?><!--datos de ubicacion de los componentes-->	
    <body>
        ...
        <div class="container-fluid">
            ...
            <!--contador de componentes disponibles en la ubicacion actual -->
...
<!--imprimir-->								
<h4 id="sc">Location:<?php echo $location_row['stdev_location_name']; ?> todos los componentes
  ...
  <div class="row-fluid"> 
     <div class="empty">
        ...
        <?php
         ...
         $id = $row['id'];		                                               
         ?>
		   <a class="btn btn-info" id="print" data-placement="left"  href="print_list_inventory.php<?php echo '?stdev_id='.$get_id; ?>" class="btn btn-info"><i class="icon-print icon-large"></i> Imprimir lista</a>		      
...
<div class="span12">
	<form action="" method="post">    <!--tabla de cotenido-->	
...
<tr>
		<td><?php
			...
			<td width="185" class="empty"><a rel="tooltip"  title="Tranferir componente" id="e<?php echo $id; ?>" href="transfer.php<?php echo '?id='.$id; ?>&<?php echo 'stdev_id='.$get_id; ?>" class="btn btn-warning"><i class="icon-move"></i> Transferir </a>
